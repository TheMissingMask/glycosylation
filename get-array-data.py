...
f=open('CFG-probabilities.dat','w')
...
plt.savefig('all-probabilities-CFG.png',dpi=600)
plt.close()
...
plt.tight_layout()
plt.savefig('higher-probabilities-CFG.png',dpi=600)
plt.close()
...
plt.tight_layout()
plt.savefig('lower-probabilities-CFG.png',dpi=600)
plt.close()
